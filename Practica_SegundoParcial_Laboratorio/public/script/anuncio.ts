class Anuncio
{
    ...
    protected transaccion:tipoTransaccion;
    ...
    constructor(id:any, titulo:string, descripcion:string, transaccion:tipoTransaccion, precio:number,
    ...
    get getTransaccion():tipoTransaccion{return this.transaccion;};
    set setTransaccion(e:tipoTransaccion){this.transaccion = e};

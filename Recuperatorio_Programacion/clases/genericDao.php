...
class GenericDao
{
    ...
    public function getObjects($attrKeyOne, $attrValueOne,$attrKeyTwo, $attrValueTwo)
    {
        try {
            $objects = json_decode($this->listar());
            $retorno = array();
    ...
    public function getObject($attrKeyOne, $attrValueOne,$attrKeyTwo, $attrValueTwo, $cantidad)
    {
        try {
            $objects = json_decode($this->listar());
            $retorno = array();

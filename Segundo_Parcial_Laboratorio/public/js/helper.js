...
function crearTabla(array) {
    ...
    tabla.className= "table table-light  table-striped table-hover";
...
function crearBoxes(array, seccion) {
    for (atributo in array[0]) {
        if (atributo != "id" && atributo != "active") {          
            ...
            if(atributo == "num_wc" || atributo == "num_estacionamiento" || atributo == "num_dormitorio")
            {

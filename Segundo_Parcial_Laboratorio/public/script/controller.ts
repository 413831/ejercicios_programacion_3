/// <reference path="anuncio.ts" />
  ...
  class Controller
  {
    ...
    public static alta(anuncios:Array<BienRaiz>):Array<BienRaiz> {
      ...
      let transaccion:ETransaccion = this.tipoTransaccion(String($("input[name='transaccion']:checked").val()));

      let anuncio = new BienRaiz(id, titulo,descripcion, transaccion, precio, num_wc, estacionamientos,dormitorios);
    ...
    public static baja(anuncios:Array<BienRaiz>):Array<BienRaiz> {
      let id:number = Number($("#id").val());
      let index:number = this.GetIndex(id, anuncios);
      let anuncio:BienRaiz = this.GetById(id,anuncios);
    ...
    public static modificar(anuncios:Array<BienRaiz>):Array<BienRaiz> {
      let titulo:string = String($("#titulo").val());
      let descripcion:string = String($("#descripcion").val());
      let precio:number = Number($("#precio").val());
      let num_wc:number = Number($("#num_wc").val());
    ...
    private static GetById(id:number, listado:Array<BienRaiz>): BienRaiz
    {
      let objeto:BienRaiz[] = listado;
      if(listado)
      {
    ...
    public static tipoTransaccion(value:String):ETransaccion
    {
